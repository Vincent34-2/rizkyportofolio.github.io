...
// Menggunakan icon standar yang pasti ada di react-icons/si
import {
  SiPhp,
  SiFlutter,
  SiDart,
...
// Memanfaatkan lucide-react sebagai pengganti icon yang hilang
import { 
  Globe, 
  Workflow, 
  ShieldCheck, 
...
const stackCategories = [
  {
    ...
    skills: [
      { name: "PHP", icon: SiPhp },
      { name: "CodeIgniter 3", icon: Layers }, // Diganti ke icon Layers dari Lucide
  ...
  {
    title: "Frontend",
    description: "User interfaces & structure",
    skills: [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "SQL Queries", icon: Database },
      { name: "MS Excel", icon: FileSpreadsheet }, // Diganti ke icon FileSpreadsheet dari Lucide
    ]
  },
  {
    title: "Analysis & Governance",
    description: "IT architecture & strategy",
    skills: [
      { name: "UML Design", icon: Workflow },
      { name: "COBIT 5", icon: ShieldCheck },
      { name: "CRM", icon: Users },
    ]
  }
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:sticky lg:top-36 flex flex-col pt-4">
            ...
            >
              <p>
                A toolkit of frameworks, methodologies, and technologies utilized for system analysis, IT governance, and robust application development.
              </p>
            </Gsap.div>
          </div>
